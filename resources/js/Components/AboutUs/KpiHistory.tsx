        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-100 flex items-center justify-center p-4 md:p-6 lg:p-10">
                ...
                >
                    ...
                    <button onClick={onClose} className="absolute top-4 right-4 md:top-6 md:right-6 text-slate-400 hover:text-white transition-colors z-50 bg-[#070D18]/50 md:bg-transparent rounded-full p-1 md:p-0 cursor-pointer">
                        ...
                        <div className="mt-4 md:mt-6 flex flex-col md:grow min-h-0 md:min-h-80">
                            ...
                            <div className="flex items-end justify-center gap-2 lg:gap-4 w-full h-56 md:h-auto md:grow pb-2 md:pb-8">
                                {podiumMembers.map((member) => {
                                    ...
                                    return (
                                        <div key={member.name} className={`relative flex flex-col justify-end w-[32%] max-w-[180px] rounded-2xl overflow-hidden border border-[#1A2333] bg-[#0B1524] ${heightClass} shadow-lg transition-transform hover:-translate-y-1`}>
                                    ...
                                    <div key={index} className="flex flex-col">
                                        ...
                                        <div className="flex flex-col gap-2 md:gap-3">
                                            {data.members.map((member: any) => (
                                                <div key={member.name} className="flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-xl border border-[#1A2333] bg-[#0D182A]/50 hover:bg-[#0D182A]/90 transition-colors">
                                                    ...
                                                    <div className="w-10 h-10 md:w-14 md:h-14 rounded-md overflow-hidden relative bg-slate-800 shrink-0">
                                                        {member.image && <img src={member.image} alt={member.name} className="absolute inset-0 w-full h-full object-cover object-top" />}
                                                    </div>
