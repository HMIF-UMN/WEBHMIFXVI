...
export default function Edit({ article, categories }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('admin.information.update', article.id), { forceFormData: true });
    };
        ...
        <AdminLayout>
            ...
            <div className="bg-[#1a1a1a] border border-gray-800 rounded-lg p-6 max-w-3xl">
                <form onSubmit={submit} className="space-y-5">
                    ...
                    <div>
                        <label className="block text-sm text-gray-400 mb-1">Replace Image</label>
                        <div className="flex items-center gap-4 mb-2">
                            <img
                                src={article.image_url}
                                alt={article.image_alt ?? ''}
                                className="w-40 aspect-video object-cover rounded border border-gray-800"
                            />
                        ...
                        {preview && (
                            <img
                                src={preview}
                                alt="preview"
                                className="mt-3 w-40 aspect-video object-cover rounded border border-amber-500/40"
                            />
                        )}
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={14}
                            className="w-full bg-[#111] border border-gray-700 rounded px-3 py-2 text-sm text-gray-200 focus:outline-none focus:border-amber-500 resize-y"
                        />
